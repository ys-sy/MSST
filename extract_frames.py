...
parser.add_argument('--video_dir', type=str, default='./raw_videos', required=True)
parser.add_argument('--frame_dir', type=str, default='./raw_frames', required=True)
parser.add_argument('--num_processes', type=int, default=16)
args = parser.parse_args()


def main(video_file, frame_rate=30, clip_start=1):
    ...
    try:
        ...
        ffmpeg_command = 'ffmpeg -ss {} -i {} -qscale:v 1 -vf "scale=604:340,fps={}" {} -loglevel error < /dev/null'.format(
            clip_start,
            video_path,
            frame_rate,
            frame_path,
